...
Table 1.2. Traceability between objectives, scope, and thesis deliverables.
...
Table 4.6. Main server API groups and implementation meaning.
Table 4.5. Testing scope identified from source files.
Table 4.7. Suggested evaluation scenarios for the final defense.
Table 4.8. Recommended deployment stages for safer rollout.
Table 5.1. Traceability of contributions to source areas.
Table 5.2. Before-and-after evaluation of the main contributions.
Table 5.3. Risk register connected to the main contributions.
...
### 2.3.1 Description of use case: Dashboard authentication
...
### 2.3.2 Description of use case: Agent enrollment and heartbeat
...
### 2.3.3 Description of use case: Whitelist profile preparation
...
### 2.3.4 Description of use case: Endpoint enforcement
...
### 2.3.5 Description of use case: Network log review
...
## 3.8 Technology trade-off summary
...
## 5.6 Integrated contribution evaluation
...
| server | server/tests/test_request_ip.py | FakeAuditModel | test_get_client_ip_uses_forwarded_for_first_ip, test_get_client_ip_uses_real_ip_when_forwarded_for_missing, test_get_client_ip_falls_back_to_remote_addr, test_get_client_ip_outside_request_context_uses_default, test_audit_service_auto_ip_uses_forwarded_header |
...
| server | server/utils/__init__.py |  |  |
| server | server/utils/request_ip.py |  | _first_header_ip, get_client_ip |
